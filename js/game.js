...
w:(1.05+r2*0.75)*ps,
ci:clamp(Math.round((0.25+depth*0.35+r3*0.4+ns*0.08)*3),0,3),
al:0.55+r2*0.3,
lw:0.7*ps,
hl:q!=='low'&&((hsh>>5)&3)===0,
ph:r2*6.28,
...
const c=GRASS_PAL[b.ci];
ctx.fillStyle='rgba('+c[0]+','+c[1]+','+c[2]+','+b.al.toFixed(2)+')';
ctx.beginPath();
...
ctx.fill();
if(b.hl){
ctx.strokeStyle='rgba(168,216,128,'+(0.35*b.ps).toFixed(2)+')';
ctx.lineWidth=b.lw;
